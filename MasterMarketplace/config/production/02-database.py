try:
    from MasterMarketplace.config.secret import DATABASE_PASSWORD_IMPORT
except ImportError:
    from MasterMarketplace.secret import DATABASE_PASSWORD_IMPORT
...
ASGI_APPLICATION = 'MasterMarketplace.routing.application'
CHANNEL_LAYERS = {
    'default': {
